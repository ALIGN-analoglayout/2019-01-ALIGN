...
Switch_PMOS_3x4 MP0 ( .net7(net7), .IBS_IN(IBS_IN), .VDD(VDD) ); 
Switch_PMOS_3x4 MP1 ( .IBS_IN(IBS_IN), .IBS_IN(IBS_IN), .VDD(VDD) ); 
Switch_PMOS_3x4 MP2 ( .IBSp_OUT(IBS_IN), .IBS_IN(IBSp_OUT), .VDD(VDD) ); 
...
SCM_NMOS_50_1x12 MN1_MN2 ( .D1(net7), .D2(IBSn_OUT), .S(VSS) ); 
